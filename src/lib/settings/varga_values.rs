...
impl VargaItem {
  pub fn new(num: u16, parashari: bool, parivritti: bool, tajik: bool, nadi: bool) -> VargaItem {
    VargaItem { num, parashari, parivritti, tajik, nadi }
  }
}

pub fn all_varga_items() -> Vec<VargaItem> {
  vec![
